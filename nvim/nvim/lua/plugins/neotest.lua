return {
  -- Neotest setup
  {
    ...
    keys = {
      ...
      { "<leader>tD", function() require("neotest").run.run({ suite = false, vim.fn.expand("%"), strategy = "dap" }) end, desc = "Debug current file" },
    },
  },
  ...
  -- Code coverage highlights
  {
	...
	-- stylua: ignore
    keys = {
      { "<leader>tcl", function() require("coverage").load(true) end, desc = "[t]est [c]overage [l]oad and show" },
      { "<leader>tct", function() require("coverage").toggle() end,   desc = "[t]est [c]overage [t]oggle" },
      { "<leader>tcc", function() require("coverage").toggle() end,   desc = "[t]est [c]overage [c]lear" },
      { "<leader>tcs", function() require("coverage").summary() end,  desc = "[t]est [c]overage [s]ummary" },
